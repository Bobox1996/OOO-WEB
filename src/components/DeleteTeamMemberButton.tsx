...
export default function DeleteTeamMemberButton({ memberId, memberName }: DeleteTeamMemberButtonProps) {
    ...
    return (
      <div className="fixed inset-0 bg-white/95 flex items-center justify-center z-50">
        <div className="max-w-md w-full mx-4 border border-black p-8">
          <h3 className="text-lg font-semibold mb-2 uppercase tracking-wider">Delete Team Member?</h3>
