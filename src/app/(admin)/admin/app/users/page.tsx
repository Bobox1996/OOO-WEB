...
import DeleteAppUserButton from '@/components/admin/DeleteAppUserButton'
import StopAppUserToggle from '@/components/ui/StopAppUserToggle'
    ...
    <>
      ...
      <div className="flex items-end justify-between mb-8">
        <div>
          ...
          <p className="text-neutral-500 mt-2">Manage users who can access the APP</p>
        </div>
        <Link
